...
| `mo-route-applicants.jspf` | `applicants` | Per-course applicant list (compact strips), MO selection actions, and `#moApplicantDetailModal` for detail / resume / MO messages (driven by `applicants.js`). |
