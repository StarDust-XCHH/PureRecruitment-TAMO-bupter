...
/**
 * MO 标记已读：写入 MO 已读表，并将 TA {@code applications.json} 对应记录置为 {@code UNDER_REVIEW}。
 */
@WebServlet(name = "moApplicationMarkReadServlet", value = "/api/mo/applications/mark-read")
public class MoApplicationMarkReadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            JsonObject result = recruitmentDao.markApplicationReadByMo(moId, applicationId);
            ...
            resp.getWriter().write(gson.toJson(ApiResponse.failure("标记已读失败: " + ex.getMessage())));
        }
    }
